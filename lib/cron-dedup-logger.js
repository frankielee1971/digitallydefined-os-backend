...
const LOG_PATH = process.env.CRON_LOG_PATH ? path.resolve(process.cron_LOG_PATH || process.env.CRON_LOG_PATH) : null;
const DEDUP_PATH = process.env.CRON_DEDUP_STORE_PATH ? path.resolve(process.env.CRON_DEDUP_STORE_PATH) : null;
