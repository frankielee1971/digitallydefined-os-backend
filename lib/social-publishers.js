...
const PUBLISHER_ENV = {
  ...
  THREADS_ACCESS_TOKEN: process.env.THREADS_ACCESS_TOKEN || null,
  LINKEDIN_ACCESS_TOKEN: process.env.LINKEDIN_ACCESS_TOKEN || null,
  LINKEDIN_ORGANIZATION_ID: process.env.LINKEDIN_ORGANIZATION_ID || null,
  TIKTOK_ACCESS_TOKEN: process.env.TIKTOK_ACCESS_TOKEN || null,
  YOUTUBE_API_KEY: process.env.YOUTUBE_API_KEY || null,
  YOUTUBE_CHANNEL_ID: process.env.YOUTUBE_CHANNEL_ID || null,
  PINTEREST_ACCESS_TOKEN: process.env.PINTEREST_ACCESS_TOKEN || null,
  GOOGLE_SHEETS_ID: process.env.GOOGLE_SHEETS_ID || null,
