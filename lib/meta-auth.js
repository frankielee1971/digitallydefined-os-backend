...
import { maskError } from './sellable-auth.js';
...
const META_ENV = {
  ...
  FACEBOOK_ACCESS_TOKEN: process.env.FACEBOOK_ACCESS_TOKEN || null,
  FACEBOOK_PAGE_ID: process.env.FACEBOOK_PAGE_ID || null,
  FACEBOOK_GROUP_ID: process.env.FACEBOOK_GROUP_ID || null,
  ...
  THREADS_APP_ID: process.env.THREADS_APP_ID || null,
  THREADS_APP_SECRET: process.env.THREADS_APP_SECRET || null,
  THREADS_USER_ID: process.env.THREADS_USER_ID || null,
};

const DRY_RUN = process.env.SELLABLE_DRY_RUN !== 'false';
const LIVE_APPROVED = process.env.SELLABLE_LIVE_APPROVAL === 'phase19';
...
function runTests() {
  ...
  process.env.META_APP_ID = process.env.META_APP_ID || 'meta_app_id';
  process.env.META_APP_SECRET = process.env.META_APP_SECRET || 'meta_app_secret';
  process.env.FACEBOOK_ACCESS_TOKEN = process.env.FACEBOOK_ACCESS_TOKEN || 'fb_access_token';
  process.env.FACEBOOK_PAGE_ID = process.env.FACEBOOK_PAGE_ID || 'fb_page_id';
  process.env.INSTAGRAM_BUSINESS_ACCOUNT_ID = process.env.INSTAGRAM_BUSINESS_ACCOUNT_ID || 'ig_business_id';
  process.env.THREADS_APP_ID = process.env.THREADS_APP_ID || 'threads_app_id';
  process.env.THREADS_APP_SECRET = process.env.THREADS_APP_SECRET || 'threads_app_secret';
  process.env.THREADS_USER_ID = process.env.THREADS_USER_ID || 'threads_user_id';
