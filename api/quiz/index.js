 ...
 * Endpoint: /api?action=quiz  (routed by backend/api/index.js)
 *
 * Accepts:  { action: 'quiz', answers: { q1: 'builder', ... }, name?, email? }
 * Returns:  { success: true, data: { superpowerName, superpowerDescription,
 *             recommendedPathways, confidenceScore, persona,
 *             strengths, blindspots, businessModel,
 *             steps, estimatedTime, tools, nextAction } }
 *
 * This handler connects quiz answers -> digitalSuperpowerAgent
 * using JSON schema prompting and persona-specific roadmap generation.
 */
...
export default async function handler(req, res) {
  ...
  // -- Extract answers (support both body.answers and direct body) --
